...
public class RetryFromSMFJobData extends DomainDataBase{
	
	private Integer[] network_id;
	private Long pi_max_records;
	private String pi_instance_id;
	private Integer[] pi_activity_id;
	private ArrayList<RetryFromSMFCursorData> cursor_data;
	...
	public ArrayList<RetryFromSMFCursorData> getCursor_data() {
		return cursor_data;
	}
	public void setCursor_data(ArrayList<RetryFromSMFCursorData> cursor_data) {
		this.cursor_data = cursor_data;
	}
	@Override
	public String toString() {
		return "RetryFromSMFJobData [network_id=" + Arrays.toString(network_id)
