...
public class PrepaidRegStatusData extends DomainDataBase {

	private String  pio_trans_id;
	private String pi_sim_serial_no;
	private Long   pi_msisdn_no;
	private String pi_ext_transid;
	List <PrepaidRegStatusRefCurData> po_sim_reg_status;

	public String getPi_ext_transid() {
		return pi_ext_transid;
	}

	public void setPi_ext_transid(String pi_ext_transid) {
		this.pi_ext_transid = pi_ext_transid;
	}
	...
	public List<PrepaidRegStatusRefCurData> getPo_sim_reg_status() {
