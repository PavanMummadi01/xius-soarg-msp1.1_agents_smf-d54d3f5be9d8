...
public class BulkSplCreditUpldData  extends  DomainDataBase{
	
     private Long[] pi_msisdn_no       ;
     private BigDecimal[] pi_credit_amount   ;
     ...
     private String[]   pi_validity_date  ;
     private String[]  pi_gp_end_date     ;
     private String[]  pi_expiry_date     ;
     
	public String[] getPi_validity_date() {
		return pi_validity_date;
	}
	public void setPi_validity_date(String[] pi_validity_date) {
		this.pi_validity_date = pi_validity_date;
	}
	public String[] getPi_gp_end_date() {
		return pi_gp_end_date;
	}
	public void setPi_gp_end_date(String[] pi_gp_end_date) {
		this.pi_gp_end_date = pi_gp_end_date;
	}
	public String[] getPi_expiry_date() {
		return pi_expiry_date;
	}
	public void setPi_expiry_date(String[] pi_expiry_date) {
		this.pi_expiry_date = pi_expiry_date;
	}
	...
	public BigDecimal[] getPi_credit_amount() {
		return pi_credit_amount;
	}
	public void setPi_credit_amount(BigDecimal[] pi_credit_amount) {
		this.pi_credit_amount = pi_credit_amount;
	}
