...
public class DebitTransactionUpdateData extends DomainDataBase {

	private String pi_transaction_id;
	private Long  pi_ext_error_code;
	...
	public Long getPi_ext_error_code() {
		return pi_ext_error_code;
	}
	public void setPi_ext_error_code(Long pi_ext_error_code) {
