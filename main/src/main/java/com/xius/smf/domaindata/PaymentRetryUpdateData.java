...
public class PaymentRetryUpdateData extends DomainDataBase {

	private String pi_retry_transaction_id;
	...
	public String getPi_retry_transaction_id() {
		return pi_retry_transaction_id;
	}

	public void setPi_retry_transaction_id(String pi_retry_transaction_id) {
		this.pi_retry_transaction_id = pi_retry_transaction_id;
	}
	...
	public String toString() {
		return "PaymentRetryUpdateData [pi_retry_transaction_id="
				+ pi_retry_transaction_id + ", pi_status=" + pi_status
				+ ", pi_payment_type=" + pi_payment_type + ", pi_ext_err_code="
				+ pi_ext_err_code + ", pi_ext_trans_id=" + pi_ext_trans_id
