...
public class BulkActDeactUpdateData extends DomainDataBase {
	...
	public String toString() {
		return "BulkActDeactUpdateData [pi_transaction_id=" + pi_transaction_id
				+ ", pi_charge=" + pi_charge + ", pi_account_id="
				+ pi_account_id + ", pi_status=" + pi_status + ", pi_remarks="
				+ pi_remarks + ", pi_ext_error_code=" + pi_ext_error_code + "]";
	}
