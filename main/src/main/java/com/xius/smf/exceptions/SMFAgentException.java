...
public class SMFAgentException extends Exception {

	private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LogManager.getLogger(SMFAgentException.class);

	private Properties errorProps = null;
	private java.lang.String errorCode;
	private java.lang.String errorMessage;

	public SMFAgentException(String errorCode, String errorMessage ) {
