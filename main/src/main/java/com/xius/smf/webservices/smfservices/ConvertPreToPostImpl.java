...
@Service("ConvertPreToPostImpl")
public class ConvertPreToPostImpl {
	private  static final Logger logger = LogManager.getLogger(ConvertPreToPostImpl.class.getSimpleName());
	public ConvertPreToPostResponse ConvertPreToPost(ConvertPreToPostRequest request,HeaderDetails header) throws RemoteException,
			SMFAgentException {
	...
	private ConvertPreToPostData setRequestData(ConvertPreToPostRequest request,
		...
		if(request.getCreditLimit()!=null)
			...
			if(request.getTariffPlanID()!=null)
				domainData.setPi_tariff_pack_id(Long.parseLong(request.getTariffPlanID()));
	...
	private ConvertPreToPostResponse setWebserviceResponse(
