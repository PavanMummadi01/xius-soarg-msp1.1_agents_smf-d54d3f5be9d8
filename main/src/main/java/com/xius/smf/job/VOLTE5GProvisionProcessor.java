...
public class VOLTE5GProvisionProcessor implements Runnable {
	
	private static final Logger logger = LogManager.getLogger(VOLTE5GProvisionProcessor.class.getSimpleName());
	...
	public VOLTE5GProvisionProcessor(CountDownLatch latch,
	...
	public VOLTE5GProvisionProcessor(VOLTECursorData curData) {
		this.cursorData = curData;
	}
	...
	public void callProvision() {
		...
		try {
			...
			logger.error(
					"Exception in VOLTE5GProvisionProcessor while getsubdata for MSISDN="
