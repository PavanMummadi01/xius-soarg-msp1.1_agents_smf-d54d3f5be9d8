 ...
 *         &lt;element name="transationId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "IMEIUnlockResponse")
public class IMEIUnlockResponse {

    protected String respCode;
    protected String respDescription;
    protected String transationId;
    ...
    /**
     * Gets the value of the transationId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the transationId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTransationId(String value) {
        this.transationId = value;
    }
