...
public class NotificationManagementServiceLocator extends org.apache.axis.client.Service implements com.xius.ne.NotificationManagement_wsdl.NotificationManagementService {
    ...
    public com.xius.ne.NotificationManagement_wsdl.NotificationManagementPortType getNotificationManagementPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.xius.ne.NotificationManagement_wsdl.NotificationManagementPortType getNotificationManagementPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xius.ne.NotificationManagement_wsdl.NotificationManagementBindingStub _stub = new com.xius.ne.NotificationManagement_wsdl.NotificationManagementBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.xius.ne.NotificationManagement_wsdl.NotificationManagementPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xius.ne.NotificationManagement_wsdl.NotificationManagementBindingStub _stub = new com.xius.ne.NotificationManagement_wsdl.NotificationManagementBindingStub(new java.net.URL(NotificationManagementPort_address), this);
                _stub.setPortName(getNotificationManagementPortWSDDServiceName());
                return _stub;
            }
        }
