...
public class ChangeSubMSISDNResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the responseData value for this ChangeSubMSISDNResponse.
     * 
     * @return responseData
     */
    ...
    /**
     * Sets the responseData value for this ChangeSubMSISDNResponse.
     * 
     * @param responseData
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tia.xius.com/TIAManagement.xsd", "ChangeSubMSISDNResponse"));
