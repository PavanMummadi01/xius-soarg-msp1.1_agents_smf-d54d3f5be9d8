...
public class SIMSwapResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the responseData value for this SIMSwapResponse.
     * 
     * @return responseData
     */
    ...
    /**
     * Sets the responseData value for this SIMSwapResponse.
     * 
     * @param responseData
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tia.xius.com/TIAManagement.xsd", "SIMSwapResponse"));
