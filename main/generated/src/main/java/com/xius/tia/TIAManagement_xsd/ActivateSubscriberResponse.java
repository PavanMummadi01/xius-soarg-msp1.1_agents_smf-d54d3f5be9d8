...
public class ActivateSubscriberResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the responseData value for this ActivateSubscriberResponse.
     * 
     * @return responseData
     */
    ...
    /**
     * Sets the responseData value for this ActivateSubscriberResponse.
     * 
     * @param responseData
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tia.xius.com/TIAManagement.xsd", "ActivateSubscriberResponse"));
