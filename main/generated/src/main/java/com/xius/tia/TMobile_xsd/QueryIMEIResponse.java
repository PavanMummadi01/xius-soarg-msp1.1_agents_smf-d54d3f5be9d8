...
public class QueryIMEIResponse  implements java.io.Serializable {
    ...
    private com.xius.tia.TMobile_xsd.IMEIInfoType IMEIInfo;
    ...
    public QueryIMEIResponse(
           ...
           com.xius.tia.TMobile_xsd.IMEIInfoType IMEIInfo,
    ...
    /**
     * Gets the partnerTransactionID value for this QueryIMEIResponse.
     * 
    ...
    /**
     * Sets the partnerTransactionID value for this QueryIMEIResponse.
     * 
    ...
    /**
     * Gets the partnerID value for this QueryIMEIResponse.
     * 
     * @return partnerID
     */
    ...
    /**
     * Sets the partnerID value for this QueryIMEIResponse.
     * 
     * @param partnerID
     */
    ...
    /**
     * Gets the status value for this QueryIMEIResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this QueryIMEIResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the action value for this QueryIMEIResponse.
     * 
     * @return action
     */
    ...
    /**
     * Sets the action value for this QueryIMEIResponse.
     * 
     * @param action
     */
    ...
    /**
     * Gets the MSISDN value for this QueryIMEIResponse.
     * 
     * @return MSISDN
     */
    ...
    /**
     * Sets the MSISDN value for this QueryIMEIResponse.
     * 
     * @param MSISDN
     */
    ...
    /**
     * Gets the IMEIInfo value for this QueryIMEIResponse.
     * 
     * @return IMEIInfo
     */
    public com.xius.tia.TMobile_xsd.IMEIInfoType getIMEIInfo() {
        return IMEIInfo;
    }


    /**
     * Sets the IMEIInfo value for this QueryIMEIResponse.
     * 
     * @param IMEIInfo
     */
    public void setIMEIInfo(com.xius.tia.TMobile_xsd.IMEIInfoType IMEIInfo) {
        this.IMEIInfo = IMEIInfo;
    }


    /**
     * Gets the result value for this QueryIMEIResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this QueryIMEIResponse.
     * 
     * @param result
     */
    ...
    /**
     * Gets the resultStatus value for this QueryIMEIResponse.
     * 
     * @return resultStatus
     */
    ...
    /**
     * Sets the resultStatus value for this QueryIMEIResponse.
     * 
     * @param resultStatus
     */
    ...
    /**
     * Gets the resultMessage value for this QueryIMEIResponse.
     * 
    ...
    /**
     * Sets the resultMessage value for this QueryIMEIResponse.
     * 
     * @param resultMessage
     */
    ...
    /**
     * Gets the responseCount value for this QueryIMEIResponse.
     * 
    ...
    /**
     * Sets the responseCount value for this QueryIMEIResponse.
     * 
     * @param responseCount
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryIMEIResponse)) return false;
        QueryIMEIResponse other = (QueryIMEIResponse) obj;
        ...
        _equals = true && 
            ...
            ((this.IMEIInfo==null && other.getIMEIInfo()==null) || 
             (this.IMEIInfo!=null &&
              this.IMEIInfo.equals(other.getIMEIInfo()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getIMEIInfo() != null) {
            _hashCode += getIMEIInfo().hashCode();
        }
        if (getResult() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryIMEIResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tia.xius.com/TMobile.xsd", "QueryIMEIResponse"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("IMEIInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tia.xius.com/TMobile.xsd", "IMEIInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://tia.xius.com/TMobile.xsd", "IMEIInfoType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
