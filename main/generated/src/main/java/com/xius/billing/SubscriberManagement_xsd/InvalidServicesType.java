...
public class InvalidServicesType  implements java.io.Serializable {
    private com.xius.billing.SubscriberManagement_xsd.ServiceType[] service;
    ...
    public InvalidServicesType(
           com.xius.billing.SubscriberManagement_xsd.ServiceType[] service,
     ...
     * @return service
     */
    public com.xius.billing.SubscriberManagement_xsd.ServiceType[] getService() {
        return service;
    }
     ...
     * @param service
     */
    public void setService(com.xius.billing.SubscriberManagement_xsd.ServiceType[] service) {
        this.service = service;
    }

    public com.xius.billing.SubscriberManagement_xsd.ServiceType getService(int i) {
        return this.service[i];
    }

    public void setService(int i, com.xius.billing.SubscriberManagement_xsd.ServiceType _value) {
