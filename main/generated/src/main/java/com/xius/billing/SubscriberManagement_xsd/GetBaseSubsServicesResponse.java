...
public class GetBaseSubsServicesResponse  implements java.io.Serializable {
    private com.xius.billing.SubscriberManagement_xsd.SubscriberServicesItem[] subsSvcs;

    public GetBaseSubsServicesResponse() {
    }

    public GetBaseSubsServicesResponse(
           com.xius.billing.SubscriberManagement_xsd.SubscriberServicesItem[] subsSvcs) {
     ...
     * @return subsSvcs
     */
    public com.xius.billing.SubscriberManagement_xsd.SubscriberServicesItem[] getSubsSvcs() {
        return subsSvcs;
    }
     ...
     * @param subsSvcs
     */
    public void setSubsSvcs(com.xius.billing.SubscriberManagement_xsd.SubscriberServicesItem[] subsSvcs) {
        this.subsSvcs = subsSvcs;
    }
