...
public class UnSubOptionalServicesSuccessType  implements java.io.Serializable {
    ...
    private com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType[] unSubservicesSuccess;
    ...
    public UnSubOptionalServicesSuccessType(
           ...
           com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType[] unSubservicesSuccess) {
     ...
     */
    public com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType[] getUnSubservicesSuccess() {
        return unSubservicesSuccess;
    }
     ...
     */
    public void setUnSubservicesSuccess(com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType[] unSubservicesSuccess) {
        this.unSubservicesSuccess = unSubservicesSuccess;
    }

    public com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType getUnSubservicesSuccess(int i) {
        return this.unSubservicesSuccess[i];
    }

    public void setUnSubservicesSuccess(int i, com.xius.billing.SubscriberManagement_xsd.ServiceSuccessType _value) {
