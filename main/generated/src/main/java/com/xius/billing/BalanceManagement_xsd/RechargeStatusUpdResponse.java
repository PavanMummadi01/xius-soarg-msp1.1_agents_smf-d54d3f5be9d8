...
public class RechargeStatusUpdResponse  implements java.io.Serializable {
    private com.xius.billing.BalanceManagement_xsd.PublicityIdType[] publicityId;
    ...
    public RechargeStatusUpdResponse(
           com.xius.billing.BalanceManagement_xsd.PublicityIdType[] publicityId,
     ...
     * @return publicityId
     */
    public com.xius.billing.BalanceManagement_xsd.PublicityIdType[] getPublicityId() {
        return publicityId;
    }
     ...
     * @param publicityId
     */
    public void setPublicityId(com.xius.billing.BalanceManagement_xsd.PublicityIdType[] publicityId) {
        this.publicityId = publicityId;
    }

    public com.xius.billing.BalanceManagement_xsd.PublicityIdType getPublicityId(int i) {
        return this.publicityId[i];
    }

    public void setPublicityId(int i, com.xius.billing.BalanceManagement_xsd.PublicityIdType _value) {
