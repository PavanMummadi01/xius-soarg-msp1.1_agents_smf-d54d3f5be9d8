...
public class NotesListType  implements java.io.Serializable {
    private com.xius.billing.SubscriberManagement_xsd.NotesType criticalNote;

    private com.xius.billing.SubscriberManagement_xsd.NotesType[] notes;

    public NotesListType() {
    }

    public NotesListType(
           com.xius.billing.SubscriberManagement_xsd.NotesType criticalNote,
           com.xius.billing.SubscriberManagement_xsd.NotesType[] notes) {
     ...
     * @return criticalNote
     */
    public com.xius.billing.SubscriberManagement_xsd.NotesType getCriticalNote() {
        return criticalNote;
    }
     ...
     * @param criticalNote
     */
    public void setCriticalNote(com.xius.billing.SubscriberManagement_xsd.NotesType criticalNote) {
        this.criticalNote = criticalNote;
    }
     ...
     * @return notes
     */
    public com.xius.billing.SubscriberManagement_xsd.NotesType[] getNotes() {
        return notes;
    }
     ...
     * @param notes
     */
    public void setNotes(com.xius.billing.SubscriberManagement_xsd.NotesType[] notes) {
        this.notes = notes;
    }

    public com.xius.billing.SubscriberManagement_xsd.NotesType getNotes(int i) {
        return this.notes[i];
    }

    public void setNotes(int i, com.xius.billing.SubscriberManagement_xsd.NotesType _value) {
        this.notes[i] = _value;
    }
