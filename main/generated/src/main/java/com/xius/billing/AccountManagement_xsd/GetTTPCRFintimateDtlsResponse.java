...
public class GetTTPCRFintimateDtlsResponse  implements java.io.Serializable {
    ...
    private com.xius.billing.AccountManagement_xsd.AtpDetailsType[] atpDetails;
    ...
    public GetTTPCRFintimateDtlsResponse(
           ...
           com.xius.billing.AccountManagement_xsd.AtpDetailsType[] atpDetails) {
     ...
     * @return atpDetails
     */
    public com.xius.billing.AccountManagement_xsd.AtpDetailsType[] getAtpDetails() {
        return atpDetails;
    }
     ...
     * @param atpDetails
     */
    public void setAtpDetails(com.xius.billing.AccountManagement_xsd.AtpDetailsType[] atpDetails) {
        this.atpDetails = atpDetails;
    }

    public com.xius.billing.AccountManagement_xsd.AtpDetailsType getAtpDetails(int i) {
        return this.atpDetails[i];
    }

    public void setAtpDetails(int i, com.xius.billing.AccountManagement_xsd.AtpDetailsType _value) {
