...
public class SubscriberServiceLocator extends org.apache.axis.client.Service implements com.xius.billing.SubscriberManagement_wsdl.SubscriberService {
    ...
    public com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementPortType getSubscriberManagementPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementPortType getSubscriberManagementPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementBindingStub _stub = new com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementBindingStub _stub = new com.xius.billing.SubscriberManagement_wsdl.SubscriberManagementBindingStub(new java.net.URL(SubscriberManagementPort_address), this);
                _stub.setPortName(getSubscriberManagementPortWSDDServiceName());
                return _stub;
            }
        }
