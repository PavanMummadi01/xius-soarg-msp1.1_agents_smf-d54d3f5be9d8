...
public class GetServicesResponse  extends com.xius.xbus.messages.common.WSResponse  implements java.io.Serializable {
    ...
    private com.xius.xbus.messages.selfcare.services.SubscribeServiceSuccessType[] servicePlan;
    ...
    public GetServicesResponse(
           ...
           com.xius.xbus.messages.selfcare.services.SubscribeServiceSuccessType[] servicePlan) {
        super(
            statusCode,
            timeStamp,
            correlationID,
     ...
     * @return servicePlan
     */
    public com.xius.xbus.messages.selfcare.services.SubscribeServiceSuccessType[] getServicePlan() {
        return servicePlan;
    }
     ...
     * @param servicePlan
     */
    public void setServicePlan(com.xius.xbus.messages.selfcare.services.SubscribeServiceSuccessType[] servicePlan) {
        this.servicePlan = servicePlan;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", ">getServicesResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "tariffPlanName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "servicePlan"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "SubscribeServiceSuccessType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "availableServicePlans"));
        typeDesc.addFieldDesc(elemField);
    }
