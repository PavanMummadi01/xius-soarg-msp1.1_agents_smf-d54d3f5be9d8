...
public class UpdateServicesResponseUnSubscribedServices  implements java.io.Serializable {
    private com.xius.xbus.messages.selfcare.services.Service[] unSubSuccessList;

    private com.xius.xbus.messages.selfcare.services.Service[] unSubFailureList;

    public UpdateServicesResponseUnSubscribedServices() {
    }

    public UpdateServicesResponseUnSubscribedServices(
           com.xius.xbus.messages.selfcare.services.Service[] unSubSuccessList,
           com.xius.xbus.messages.selfcare.services.Service[] unSubFailureList) {
     ...
     */
    public com.xius.xbus.messages.selfcare.services.Service[] getUnSubSuccessList() {
        return unSubSuccessList;
    }
     ...
     */
    public void setUnSubSuccessList(com.xius.xbus.messages.selfcare.services.Service[] unSubSuccessList) {
        this.unSubSuccessList = unSubSuccessList;
    }
     ...
     */
    public com.xius.xbus.messages.selfcare.services.Service[] getUnSubFailureList() {
        return unSubFailureList;
    }
     ...
     */
    public void setUnSubFailureList(com.xius.xbus.messages.selfcare.services.Service[] unSubFailureList) {
        this.unSubFailureList = unSubFailureList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", ">>updateServicesResponse>unSubscribedServices"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("unSubSuccessList");
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "unSubSuccessList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "unSubFailureList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "Service"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "serviceList"));
