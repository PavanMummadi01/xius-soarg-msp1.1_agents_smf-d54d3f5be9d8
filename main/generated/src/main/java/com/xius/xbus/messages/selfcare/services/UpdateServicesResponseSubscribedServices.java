...
public class UpdateServicesResponseSubscribedServices  implements java.io.Serializable {
    private com.xius.xbus.messages.selfcare.services.Service[] subSuccessList;

    private com.xius.xbus.messages.selfcare.services.Service[] subFailureList;

    public UpdateServicesResponseSubscribedServices() {
    }

    public UpdateServicesResponseSubscribedServices(
           com.xius.xbus.messages.selfcare.services.Service[] subSuccessList,
           com.xius.xbus.messages.selfcare.services.Service[] subFailureList) {
     ...
     */
    public com.xius.xbus.messages.selfcare.services.Service[] getSubSuccessList() {
        return subSuccessList;
    }
     ...
     */
    public void setSubSuccessList(com.xius.xbus.messages.selfcare.services.Service[] subSuccessList) {
        this.subSuccessList = subSuccessList;
    }
     ...
     */
    public com.xius.xbus.messages.selfcare.services.Service[] getSubFailureList() {
        return subFailureList;
    }
     ...
     */
    public void setSubFailureList(com.xius.xbus.messages.selfcare.services.Service[] subFailureList) {
        this.subFailureList = subFailureList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", ">>updateServicesResponse>subscribedServices"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("subSuccessList");
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "subSuccessList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "subFailureList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "Service"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "serviceList"));
