...
public class GetDataPlansResponse  extends com.xius.xbus.messages.common.WSResponse  implements java.io.Serializable {
    private com.xius.xbus.messages.selfcare.services.DataPlanType volumePlans;

    private com.xius.xbus.messages.selfcare.services.DataPlanType payAsGoPlans;
    ...
    public GetDataPlansResponse(
           ...
           com.xius.xbus.messages.selfcare.services.DataPlanType volumePlans,
           com.xius.xbus.messages.selfcare.services.DataPlanType payAsGoPlans) {
        super(
            statusCode,
            timeStamp,
            correlationID,
     ...
     * @return volumePlans
     */
    public com.xius.xbus.messages.selfcare.services.DataPlanType getVolumePlans() {
        return volumePlans;
    }
     ...
     * @param volumePlans
     */
    public void setVolumePlans(com.xius.xbus.messages.selfcare.services.DataPlanType volumePlans) {
        this.volumePlans = volumePlans;
    }
     ...
     * @return payAsGoPlans
     */
    public com.xius.xbus.messages.selfcare.services.DataPlanType getPayAsGoPlans() {
        return payAsGoPlans;
    }
     ...
     * @param payAsGoPlans
     */
    public void setPayAsGoPlans(com.xius.xbus.messages.selfcare.services.DataPlanType payAsGoPlans) {
        this.payAsGoPlans = payAsGoPlans;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", ">getDataPlansResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("volumePlans");
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "volumePlans"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "DataPlanType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("payAsGoPlans");
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "payAsGoPlans"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "DataPlanType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
