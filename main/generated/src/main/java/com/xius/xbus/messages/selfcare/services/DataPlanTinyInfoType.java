...
public class DataPlanTinyInfoType  implements java.io.Serializable {
    ...
    private com.xius.xbus.messages.selfcare.services.SubUnSubType subscriptionType;
    ...
    public DataPlanTinyInfoType(
           ...
           com.xius.xbus.messages.selfcare.services.SubUnSubType subscriptionType) {
     ...
     */
    public com.xius.xbus.messages.selfcare.services.SubUnSubType getSubscriptionType() {
        return subscriptionType;
    }
     ...
     */
    public void setSubscriptionType(com.xius.xbus.messages.selfcare.services.SubUnSubType subscriptionType) {
        this.subscriptionType = subscriptionType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "DataPlanTinyInfoType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "subscriptionType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/services", "SubUnSubType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
