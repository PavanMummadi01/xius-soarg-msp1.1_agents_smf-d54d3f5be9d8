...
public class DeletePackageRequest  extends com.xius.xbus.messages.common.WSRequest  implements java.io.Serializable {
    private long pkgId;
    ...
    /**
     * Gets the pkgId value for this DeletePackageRequest.
     * 
     * @return pkgId
     */
    ...
    /**
     * Sets the pkgId value for this DeletePackageRequest.
     * 
     * @param pkgId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/selfcare/communityaccountservice", ">DeletePackageRequest"));
