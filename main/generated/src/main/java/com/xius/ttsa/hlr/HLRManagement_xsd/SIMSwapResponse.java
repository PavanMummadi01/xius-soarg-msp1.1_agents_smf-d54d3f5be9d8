...
public class SIMSwapResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the returnCode value for this SIMSwapResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this SIMSwapResponse.
     * 
     * @param returnCode
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hlr.ttsa.xius.com/HLRManagement.xsd", "SIMSwapResponse"));
