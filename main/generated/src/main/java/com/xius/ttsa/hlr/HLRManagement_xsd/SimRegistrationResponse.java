...
public class SimRegistrationResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the returnCode value for this SimRegistrationResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this SimRegistrationResponse.
     * 
     * @param returnCode
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hlr.ttsa.xius.com/HLRManagement.xsd", "SimRegistrationResponse"));
