...
public class SIMSwapRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the MSISDN value for this SIMSwapRequest.
     * 
     * @return MSISDN
     */
    ...
    /**
     * Sets the MSISDN value for this SIMSwapRequest.
     * 
     * @param MSISDN
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hlr.ttsa.xius.com/HLRManagement.xsd", "SIMSwapRequest"));
