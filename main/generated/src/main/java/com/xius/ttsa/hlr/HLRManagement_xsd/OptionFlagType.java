...
public class OptionFlagType implements java.io.Serializable {
    ...
    public static final OptionFlagType ADD = new OptionFlagType(_ADD);
    public static final OptionFlagType MODIFY = new OptionFlagType(_MODIFY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hlr.ttsa.xius.com/HLRManagement.xsd", "OptionFlagType"));
    }
    /**
