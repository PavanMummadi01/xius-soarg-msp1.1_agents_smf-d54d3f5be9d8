...
public class ActionFlagType implements java.io.Serializable {
    ...
    public static final ActionFlagType BULK = new ActionFlagType(_BULK);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://scare.xbus.xiusbcgi.com/CorpManagement.xsd", "ActionFlagType"));
    }
    /**
