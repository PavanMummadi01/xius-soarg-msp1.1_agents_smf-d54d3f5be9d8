...
public class ScheduleType implements java.io.Serializable {
    ...
    public static final ScheduleType LB = new ScheduleType(_LB);
    public static final ScheduleType DM = new ScheduleType(_DM);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://scare.xbus.xiusbcgi.com/CorpManagement.xsd", "ScheduleType"));
    }
    /**
