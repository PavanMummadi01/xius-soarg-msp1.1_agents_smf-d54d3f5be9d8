...
public class ValidateIdResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the message value for this ValidateIdResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this ValidateIdResponse.
     * 
     * @param message
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://scare.xbus.xiusbcgi.com/CorpManagement.xsd", "ValidateIdResponse"));
