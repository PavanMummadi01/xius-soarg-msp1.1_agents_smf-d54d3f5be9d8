...
public class GetESNResponse  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private java.lang.String correlationID;

    private net.bcgi.si.messages.mvnoapi.common.ErrorData[] errors;

    private net.bcgi.si.messages.mvnoapi.device.DeviceHardwareData hardware;
    ...
    public GetESNResponse(
           ...
           net.bcgi.si.messages.mvnoapi.device.DeviceHardwareData hardware,
    ...
    /**
     * Gets the correlationID value for this GetESNResponse.
     * 
    ...
    /**
     * Sets the correlationID value for this GetESNResponse.
     * 
     * @param correlationID
     */
    ...
    /**
     * Gets the errors value for this GetESNResponse.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this GetESNResponse.
     * 
     * @param errors
     */
    ...
    /**
     * Gets the hardware value for this GetESNResponse.
     * 
     * @return hardware
     */
    public net.bcgi.si.messages.mvnoapi.device.DeviceHardwareData getHardware() {
        return hardware;
    }


    /**
     * Sets the hardware value for this GetESNResponse.
     * 
     * @param hardware
     */
    public void setHardware(net.bcgi.si.messages.mvnoapi.device.DeviceHardwareData hardware) {
        this.hardware = hardware;
    }


    /**
     * Gets the lockData value for this GetESNResponse.
     * 
     * @return lockData
     */
    ...
    /**
     * Sets the lockData value for this GetESNResponse.
     * 
     * @param lockData
     */
    ...
    /**
     * Gets the productSKU value for this GetESNResponse.
     * 
     * @return productSKU
     */
    ...
    /**
     * Sets the productSKU value for this GetESNResponse.
     * 
     * @param productSKU
     */
    ...
    /**
     * Gets the statusCode value for this GetESNResponse.
     * 
     * @return statusCode
     */
    ...
    /**
     * Sets the statusCode value for this GetESNResponse.
     * 
     * @param statusCode
     */
    ...
    /**
     * Gets the timeStamp value for this GetESNResponse.
     * 
     * @return timeStamp
     */
    ...
    /**
     * Sets the timeStamp value for this GetESNResponse.
     * 
     * @param timeStamp
     */
    ...
    /**
     * Gets the version value for this GetESNResponse.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetESNResponse.
     * 
     * @param version
     */
    ...
    /**
     * Gets the _any value for this GetESNResponse.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetESNResponse.
     * 
     * @param _any
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://provisioning.mvnoapi.messages.si.bcgi.net", "GetESNResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://provisioning.mvnoapi.messages.si.bcgi.net", "hardware"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://provisioning.mvnoapi.messages.si.bcgi.net", "productSKU"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
